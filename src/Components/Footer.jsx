  ...
  return (
    <div className="mt-20 bg-black pt-15 pb-7">
      <div className="w-11/12 md:w-10/12 mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
        <div className="space-y-3">
          ...
          <p className="text-gray-400">
            A customer support ticket system is a tool that organizes, tracks,
            and manages customer inquiries or issues to ensure timely and
      ...
      <div className="w-11/12 mx-auto mt-10">
        <p className="text-gray-300 text-center border-t-2 p-2">
