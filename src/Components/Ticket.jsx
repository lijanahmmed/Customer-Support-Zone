...
const Ticket = ({ ticket, progressTicket, setProgressTicket }) => {
  ...
  return (
    <div
      ...
      className="p-3 shadow-2xl bg-white space-y-2 rounded-xl cursor-pointer"
    >
      <div className="flex justify-between items-center">
        <p className="font-bold">{ticket.title}</p>
        {ticket.status == "Open" ? (
          <p className="px-3 py-2 bg-green-200 text-green-900 rounded-4xl">
            🟢Open
          </p>
        ) : ticket.status == "In-Progress" ? (
          <p className="px-3 py-2 bg-yellow-100 text-yellow-800 rounded-4xl">
            🟡In-Progress
          </p>
        ) : (
          ""
      ...
      <div className="flex justify-between items-center text-gray-500 text-sm">
        ...
        <div className="flex gap-3 items-center">
          ...
          <p className="flex gap-1 items-center">
            <span>
              <MdOutlineDateRange className="inline text-lg" />
            </span>{" "}
